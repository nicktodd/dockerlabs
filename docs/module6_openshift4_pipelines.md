# Lab 4 - Deploying to OpenShift 4 with Pipelines
...
## Prerequisites
It is recommended that you complete this exercise with the supplied sample projects, following which you may wish to experiment with your own projects. You will need to have your own Github  account.
...
6. Obtain the git url from the Github webpage for the project by clicking on the code button. Ensure you are using the forked copy of the project in your own Github account. 
...
17. When the topology screen is displayed, notice that there are now 2 application circles. One of these is for the pipeline and one for the application. Notice that the application circle has some additional icons. Click on the **build icon** to watch the build progress.
